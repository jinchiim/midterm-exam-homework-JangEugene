...
public class Menu {
        ...
        do {
            ...
            switch (num) {
                ...
                case 11:
                    ...
                    break;
                case 12:
                    System.out.print("정말 종료하시겠습니까? (예:y/아니오:n) :");
                    String check = sc.next();
                    if(check.equals("y") || check.equals("Y")){
                        end = false;;
                    } break;
                default:
                    System.out.println("잘못된 번호가 입력 되었습니다.");
            }
    ...
    public void subvarMenu(){
        ...
        do{
            ...
            System.out.println("2. 사원번호를 키보드로 입력받아 출력하기");
    ...
    public void subIfMenu(){
        ...
        do{
            ...
            System.out.println("8. 문자 하나를 입력받아, 영어대문자인지 소문자인지 숫자문자인지 기타문자인지 확인\n" +
                    "인하기");
